...
<head>
    ...
    <title>{{ config('app.name', 'RegOFIS') }}</title>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('applications.index') }}"
                                       class="nav-link {{ Request::is('home/applications*') ? 'active' : '' }}">
                                        ...
                                        <p>Arizalar ro‘yxati</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('office_applications.index') }}"
                                       class="nav-link {{ Request::is('home/office_applications*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Ofis orqali yuklash
                                        </p>
