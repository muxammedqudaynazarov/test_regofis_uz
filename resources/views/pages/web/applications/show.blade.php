                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <b class="mr-3 text-nowrap"><i class="fas fa-university text-primary mr-1"></i>
                                            Fakultet</b>
                                        <span
                                            class="text-muted text-right">{{ $app->student->specialty->department->name }}</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <b class="mr-3 text-nowrap"><i class="fas fa-book-reader text-success mr-1"></i>
                                            O‘quv reja</b>
                                        <span class="text-muted text-right">{{ $app->student->curriculum->name }}</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <b class="mr-3 text-nowrap"><i class="fas fa-language text-info mr-1"></i>
                                            Ta’lim tili</b>
                                        <span
                                            class="text-muted text-right">{{ $app->student->language->name ?? '-' }}</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <b class="mr-3 text-nowrap"><i class="far fa-clock text-warning mr-1"></i> Ariza
                                            vaqti</b>
                                        <span
                                            class="text-muted text-right">{{ $app->created_at ? $app->created_at->format('d.m.Y H:i') : '-' }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
